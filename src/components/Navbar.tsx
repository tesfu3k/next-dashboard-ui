...
const Navbar = () => {
  return (
    <div className="flex items-center justify-between p-4">
      {/* SEARCH BAR */}
      <div className="hiddn md:flex items-center gap-2 text-xs rounded-full ring-[1.5px] ring-gray-300 px-2">
      ...
      <div className="flex items-center gap-6 justify-end w-full">
        ...
        <div className="bg-white rounded-full w-7 h-7 items-center justify-center cursor-pointer relative">
          ...
          <div className="absolute -top-3 -right-3 w-5 h-5 flex place-items-center justify-center bg-purple-500 text-white rounded-full text-xs">
            1
          </div>
        </div>
